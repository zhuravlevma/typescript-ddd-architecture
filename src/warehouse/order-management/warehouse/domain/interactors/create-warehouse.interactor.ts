...
import { CreateWarehouseParams, CreateWarehouseInPort } from '../ports/in/create-warehouse.in-port';
...
export class CreateWarehouseInteractor implements CreateWarehouseInPort {
  ...
  async execute(createWarehouseParams: CreateWarehouseParams): Promise<WarehouseEntity> {
