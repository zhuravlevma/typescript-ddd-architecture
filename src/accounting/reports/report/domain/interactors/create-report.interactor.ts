...
import { CreateReportParams, CreateReportInPort } from '../ports/in/create-report.in-port';
...
export class CreateReportInteractor implements CreateReportInPort {
  ...
  async execute(createReportCommand: CreateReportParams): Promise<ReportEntity> {
